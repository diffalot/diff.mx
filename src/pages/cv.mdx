...
import PortfolioItem from '../components/CurriculumVitae/PortfolioItem'
...
about a position with {{companyName}}, I will make myself available any time that
...
_[ryzo.me](https://github.com/protest-technology/ryzome)_ is an in browser p2p data propagation backend for sharing queryable serverfree protobuf messages.

_[Congress Hotline](https://github.com/StayWokeOrg/general-congress-hotline)_ is a Twilio backed Express app with a touch tone interface that helps people to search for their congressional representatives by entering their zip code and connects them to each representative in turn.
...
<PortfolioItem
  name="https://ryzo.me"
  homepage="https://ryzo.me"
  status="in progress"
  toolchain="p2p, identity, encryption"
  link="https://git.diff.mx/diffalot/censor-scan"
  image=""
>
...
<PortfolioItem
  name="censor-scan"
  status="abandoned"
  toolchain="Node.js, PhantomJS, scraper"
  link="https://git.diff.mx/diffalot/censor-scan"
  image=""
>
